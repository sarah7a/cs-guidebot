...
const en: Dict = {
  ...
  errorMissingKey:
    "The Gemini API key is not configured. Add VITE_GEMINI_API_KEY in your environment to enable AI features.",
  retry: "Try again",
...
const ar: Dict = {
  ...
  errorMissingKey:
    "لم يتم تكوين مفتاح Gemini. أضف VITE_GEMINI_API_KEY في بيئتك لتفعيل ميزات الذكاء الاصطناعي.",
  retry: "حاول مرة أخرى",
